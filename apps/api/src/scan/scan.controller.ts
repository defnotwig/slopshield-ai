import { Controller, Post, Get, Param, Body, Query, UseGuards, UseInterceptors, UploadedFile, Req } from '@nestjs/common';
...
export class ScanController {
  ...
  public async getFindings(
    ...
    const isFalsePositive = falsePositive !== undefined ? falsePositive === 'true' : undefined;
    return this.scanService.getFindings(id, category, severity, isFalsePositive);
  }
}
