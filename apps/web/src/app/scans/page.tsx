...
import { Search, Calendar, RefreshCw, FolderOpen, ArrowRight, ArrowLeft } from 'lucide-react';
...
export default function ScansHistoryPage() {
  ...
  const { data: scansData, isLoading, refetch } = useScans(page, 10, projectId, status);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Scan Audit History</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white dark:bg-gray-900/30 p-4 border border-gray-200 dark:border-gray-800 rounded-lg">
        <div className="flex flex-wrap gap-4 items-center w-full">
          ...
          <div className="flex flex-col w-full sm:w-auto">
            <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-1">Project</span>
            <select
              value={projectId}
              onChange={(e) => {
          ...
          {/* Status Filter */}
          <div className="flex flex-col w-full sm:w-auto">
            <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider mb-1">Status Verdict</span>
            <select
              value={status}
              onChange={(e) => {
                  ...
                  <tr key={scan.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-900/20 transition-colors">
                    ...
                    <td className="px-6 py-4.5 whitespace-nowrap">
                      <span className="flex items-center gap-1.5 text-xs font-semibold text-gray-700 dark:text-gray-300">
                        ...
                        {scan.project?.name || <span className="italic text-gray-500">Ad-Hoc</span>}
                      </span>
                    </td>
