...
import { LayoutDashboard, PlusCircle, Search, FolderOpen, BookOpen, Settings, ShieldAlert, LogOut } from 'lucide-react';
      ...
      <div className="p-4 border-t border-border flex items-center justify-between gap-4 bg-muted/20">
        <div className="flex items-center gap-3">
          ...
          <div className="truncate w-24">
            <p className="text-xs font-semibold text-foreground truncate">Developer</p>
            <p className="text-[10px] text-muted-foreground truncate">dev@example.com</p>
          </div>
        </div>
        <ThemeToggle />
      </div>
