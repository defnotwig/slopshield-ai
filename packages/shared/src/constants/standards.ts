...
export const STANDARDS_REFERENCES: Record<string, StandardReference> = {
  OWASP_TOP_10: {
    ...
    description:
      "Standard awareness document for web application security risks representing broad consensus.",
  },
  OWASP_API_TOP_10: {
    id: "OWASP_API_TOP_10",
    ...
    description:
      "Security risks specific to APIs, covering authorization, rate limits, and injection flaws.",
  },
  OWASP_ASVS: {
    id: "OWASP_ASVS",
    ...
    description:
      "A framework of security requirements and controls for testing web applications.",
  },
  CWE_TOP_25: {
    id: "CWE_TOP_25",
    ...
    description:
      "A list of the most widespread and critical software weaknesses that can lead to vulnerabilities.",
  },
  NIST_SSDF: {
    id: "NIST_SSDF",
    ...
    description:
      "Guidelines for security-focused software development lifecycle practices.",
  },
  ISO_25010: {
    id: "ISO_25010",
    ...
    description:
      "International standard defining system and software quality characteristics.",
  },
  WCAG_22: {
    id: "WCAG_22",
    ...
    description:
      "Guidelines to make web content more accessible to people with disabilities.",
  },
  CLEAN_CODE: {
    id: "CLEAN_CODE",
    ...
    description:
      "Principles for writing readable, maintainable, and refactor-friendly code.",
  },
  PRAGMATIC_PROGRAMMER: {
    ...
    description:
      "Best practices for software construction, design patterns, and self-organization.",
  },
  REFACTORING: {
    id: "REFACTORING",
    ...
    description:
      "Structured techniques to improve internal code structure without changing external behavior.",
  },
  PHILOSOPHY_SOFTWARE_DESIGN: {
    ...
    description:
      "Concepts on reducing complexity in software design and managing module boundaries.",
  },
  CODE_COMPLETE: {
    id: "CODE_COMPLETE",
    ...
    description:
      "Exhaustive guide on software building, coding style, naming conventions, and validation.",
  },
};
