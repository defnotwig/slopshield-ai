...
export const CATEGORY_WEIGHTS: Record<FindingCategory, number> = {
  ...
  'backend-architecture': 0.10, // architecture split
  'frontend-architecture': 0.10,
  maintainability: 0.20,
  testability: 0.15,
  accessibility: 0.10, // Maps to "frontend" accessibility
  reliability: 0.05,
  documentation: 0.05,
  general: 0.00, // General findings carry no weight deductions on their own category
};
